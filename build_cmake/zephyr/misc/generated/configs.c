...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32CUBE_SOC_NAME_OVERRIDE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32_MIN_DEV, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32_MIN_DEV_STM32F103X8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_REVISION_BLUE, 1);
